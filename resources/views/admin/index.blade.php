    ...
    <tbody>
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.edit', $data->Id_mobil) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="hapusModal{{ $data->Id_mobil }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.delete', $data->Id_mobil) }}">
                                    @csrf
